defmodule DietProjectWeb.Router do
  use DietProjectWeb, :router

  import DietProjectWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {DietProjectWeb.Layouts, :root}
  ...
  if Application.compile_env(:diet_project, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: DietProjectWeb.Telemetry
  ...
  scope "/", DietProjectWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{DietProjectWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", DietProjectWeb do
    ...
    live_session :current_user,
      on_mount: [{DietProjectWeb.UserAuth, :mount_current_user}] do
